...
if __name__ == "__main__": 
    ...
    experiment = mlflow.set_experiment("tiempos_caja_SVR_experiment")
    ...
    with mlflow.start_run(experiment_id=experiment.experiment_id):
        ...
        model = GridSearchCV(estimator=SVR(), param_grid=param_grid, cv=5, scoring='neg_mean_squared_error', n_jobs=-1, verbose=2)
