...
if __name__ == "__main__": 
    ...
    experiment = mlflow.set_experiment("tiempos_caja_random_forest_experiment")
    ...
    with mlflow.start_run(experiment_id=experiment.experiment_id):
        ...
        model = RandomForestRegressor(n_estimators=100,max_depth=20,min_samples_split=2,min_samples_leaf=4,bootstrap=True,random_state=42)
